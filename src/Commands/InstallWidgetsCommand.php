...
class InstallWidgetsCommand extends Command
{
    /**
     * The name and signature of the console command.
     */
    protected $signature = 'widgets:install
     ...
     */
    protected $description = 'Install Widgets plugin';
    ...
    protected function buildAssets(): void
    {
        ...
        $process = Process::path(base_path('packages/laravilt/widgets'))
