...
{
    protected string $description = 'Search the Laravilt Widgets documentation';

    public function handle(Request $request): Response
    {
        $query = $request->string('query');
        $packagePath = base_path('packages/laravilt/widgets');
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            'query' => $schema->string()
                ->description('QUERY_Search the Laravilt Widgets documentation')
                ->required(),
        ];
    }
